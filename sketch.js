...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   star1 = createSprite(390,90,20,20);
   star1.addImage(star_img);
   star1.scale=0.03

   star2 = createSprite(60,390,20,20);
   star2.addImage(star_img);
   star2.scale=0.03
   
   star_display=createSprite(40,30,20,20);
   ...
   rope = new Rope(9,{x:200,y:90});
   rope2 = new Rope(9,{x:400,y:90});
...
function draw() 
{
  ...
  if(collide(fruit,star1,80)==true)
  {console.log("touchStar1")
  star1.visible=false;
  star_display.changeAnimation("one")
  }

  if(collide(fruit,star2,80)==true)
  {console.log("touchStar2")
  star2.visible=false;
